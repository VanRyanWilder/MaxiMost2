...
export default function Habits() {
  return (
    <PageContainer title="Daily Habits - Track Your Consistency">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
        <div>
          <h1 className="text-3xl font-bold">Daily Habits</h1>
          <p className="text-gray-600 mt-1">Track consistent habits for maximum results</p>
        </div>
      ...
      <div className="bg-gradient-to-r from-primary to-secondary rounded-xl p-6 text-white mb-8 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-2xl font-bold mb-2">Habit Discipline</h2>
      ...
      <Tabs defaultValue="tracker" className="mb-6">
        ...
        <TabsContent value="calendar">
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="text-muted-foreground">Coming soon! View your habits on a monthly calendar.</p>
          </div>
        </TabsContent>
      </Tabs>
    </PageContainer>
