        ...
        >
          ...
          <div className="space-y-1">
            {habits.slice(0, 3).map(habit => (
              ...
              >
                <div 
                  className={`h-3 w-3 mr-1 rounded-full ${isHabitCompletedOnDate(habit.id, day) ? '' : 'border border-gray-300'}`} 
                  style={isHabitCompletedOnDate(habit.id, day) ? { backgroundColor: getHabitColor(habit) } : {}}
                />
